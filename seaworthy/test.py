...
class TestHubContainer:
    def test_db_tables_created(self, ncreg_container, postgresql_container):
        """
        When the Django container starts, it should run its migrations
        """
        django_logs = ncreg_container.get_logs().decode("utf-8")
    ...
    def test_admin_page(self, ncreg_container, postgresql_container):
        """
