...
JEMBI_URL = env("JEMBI_URL", str, "REPLACEME")
JEMBI_USERNAME = env("JEMBI_USERNAME", str, "REPLACEME")
JEMBI_PASSWORD = env("JEMBI_PASSWORD", str, "REPLACEME")
JEMBI_AUTH = (JEMBI_USERNAME, JEMBI_PASSWORD)
